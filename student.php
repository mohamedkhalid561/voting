...
<body>
   ...
   <ul>
    ...
    echo "<a href=insert_s.php?id=".$_GET['id'].">insert</a>"."<br>";
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        . 'year: '.$row['year']."<br>"
        ."<a href=updata_s.php?id1=".$row['id'].'&name='.$row['username'].'&id2='.$_GET['id'].'&year='.$row['year']."'>updata</a>"."<br>"
        ."<a href='deletescript_S.php?id1=".$row['id'].'&id_d='.$_GET['id']."'>del</a> ".
        "<br>";
    }
