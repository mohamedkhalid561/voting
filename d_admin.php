...
<body>
   ...
   <ul>
    ...
    echo "<a href=insert_a.php?id=".$_GET['id'].">insert</a>"."<br>";
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        . 'your job: '.$row['job']."<br>"
        ."<a href=updata_a.php?id1=".$row['id'].'&name='.$row['username'].'&id2='.$_GET['id'].'&job='.$row['job']."'>updata</a>"."<br>"
        ."<a href='deletescript_a.php?id1=".$row['id'].'&id_d='.$_GET['id']."'>del</a> ".
        "<br>";
    }
