...
-->
    ...
    <?php
      ...
      <div class="main-panel" style="direction: rtl; font-family: 'Cairo', sans-serif;">
        ...
        $query="SELECT * FROM vot where id1=".$_GET['id'];
        ...
        '<div class="col-md-12 grid-margin">'.
          '<div class="d-flex justify-content-between align-items-center">'.
            '<div>'.
              '<h3 class="font-weight-bold mb-0">'.'تمت عملية التصويت بنجاح'.'</h3>'.
            '</div>'.
          '</div>'.
        '</div>'.
      '</div>';
...
while($row1=mysqli_fetch_assoc($result1)){
    if($row1['id']==$row['id2']){
        echo 
                ...
                '<img src="'.$row1['images'].'" class="card-img-top" style="max-width:800px; height:auto;" alt="...">'.
                '<div class="card-body">
                <h5 class="card-title">'.
                $row1['username'].
                '</h5>
                ...
                $row1['year'].
                '</p>'.
                '<a class="btn btn-lg btn-success disabled" tabindex="-1" role="button" aria-disabled="true">'.
                "تم التصويت".
                '</a>'.    
                "</div>
                </div>
                ...
                $row1['year'].
                '</p>'.
                '<a class="btn btn-lg btn-secondary disabled" tabindex="-1" role="button" aria-disabled="true">'.
                "Vote".
                '</a>'.
                "</div>
                </div>
